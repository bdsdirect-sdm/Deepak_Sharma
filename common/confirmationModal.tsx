...
const ConfirmationModal = ({modalData}:any) => {
  return (
    <div className="fixed inset-0 z-[1000] grid place-items-center overflow-auto bg-richblack-800 bg-opacity-15 backdrop-blur-sm">
        <div className="w-11/12 max-w-[350px] rounded-lg border border-richblack-400 bg-richblack-800 p-6">
            ...
            <div className="flex items-center gap-x-4">
                ...
                customClasses={modalData.btn1customClasses}
                />
                <button
